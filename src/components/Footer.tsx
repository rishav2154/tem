        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Your trusted partner for all your shopping needs. Quality products, amazing prices, exceptional service.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=Food" className="text-gray-300 hover:text-white transition-colors">
                  Food & Beverage
                </Link>
              </li>
            </ul>
